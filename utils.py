...
def export_prediction_as_json(image_name, mode, edges, neg_edges, results_dir, model_id):
    ...
    if not os.path.exists(f"{results_dir}/{model_id}_{image_name}_{mode}_edges_result.json"):
        open(f"{results_dir}/{model_id}_{image_name}_{mode}_edges_result.json", 'w').close()
